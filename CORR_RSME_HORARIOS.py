...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 08:16:23 2019
...
observadotemp = ('/home/leo/Documents/tesis/Metadata/FILLTEMPHORA/*')

estimadotemp = ('/home/leo/Documents/tesis/Metadata/TEMPHORA_ESTIMADA/*')

observadohum = ('/home/leo/Documents/tesis/Metadata/FILLHUMHORA/*')

estimadohum = ('/home/leo/Documents/tesis/Metadata/HUMHORA_ESTIMADA/*')
...
for OBST in glob.glob(observadotemp):
    ...
    obst = pd.DataFrame(data=obst0, columns=['mm','tn','hr'])
...
for OBSH in glob.glob(observadohum):
    ...
    obsh = pd.DataFrame(data=obsh0, columns=['mm','rh','hr'])
